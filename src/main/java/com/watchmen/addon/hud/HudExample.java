package com.watchmen.addon.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(WmLogoBuilder.HUD_GROUP, "example", "HUD element example.", HudExample::new);
